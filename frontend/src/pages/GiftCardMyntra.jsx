    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-violet-50/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-base sm:text-base text-slate-500 max-w-2xl mx-auto">Get Myntra codes at the best prices. Instant delivery via email.</p>
        </div>
